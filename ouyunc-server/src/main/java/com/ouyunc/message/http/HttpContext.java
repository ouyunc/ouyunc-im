...
public final class HttpContext {
    ...
    /** JWT 等鉴权解析出的调用方身份，HTTP 推送等场景使用 */
    private HttpAuthPrincipal authPrincipal;
    ...
    public HttpAuthPrincipal getAuthPrincipal() {
        return authPrincipal;
    }

    public void setAuthPrincipal(HttpAuthPrincipal authPrincipal) {
