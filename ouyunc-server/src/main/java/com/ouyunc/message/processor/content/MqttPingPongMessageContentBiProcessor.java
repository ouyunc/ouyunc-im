 ...
 * mqtt 心跳
 */
public class MqttPingPongMessageContentBiProcessor extends AbstractBaseBiProcessor<Mono<Void>, Integer> {
    private static final Logger log = LoggerFactory.getLogger(MqttPingPongMessageContentBiProcessor.class);
