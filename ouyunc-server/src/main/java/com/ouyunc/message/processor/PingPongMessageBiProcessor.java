 ...
 **/
public final class PingPongMessageBiProcessor extends AbstractMessageBiProcessor<Byte> {
    private static final Logger log = LoggerFactory.getLogger(PingPongMessageBiProcessor.class);
