...
/**
 * HTTP 推送：客服会话投递（ticket 消息 scope）。
 */
public enum CustomerServiceHttpPushDeliveryStrategy implements HttpProcessor {

    INSTANCE;

    private static final Logger log = LoggerFactory.getLogger(CustomerServiceHttpPushDeliveryStrategy.class);
