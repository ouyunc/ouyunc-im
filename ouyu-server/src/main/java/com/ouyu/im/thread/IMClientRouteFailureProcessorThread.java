...
public class IMClientRouteFailureProcessorThread extends AbstractIMClientRouteProcessor {
    ...
    public void process() {
        ...
        InetSocketAddress targetSocketAddress = SocketAddressUtil.convert2SocketAddress(message.getToServerAddress());
        ...
        if (currentRetry < IMServerContext.SERVER_CONFIG.getClusterServerRetry()) {
        ...
        log.error("已经重试{}次,也没解决问题，该消息将被抛弃！", IMServerContext.SERVER_CONFIG.getClusterServerRetry());
    }
}
