...
CREATE TABLE IF NOT EXISTS `cs_consultation_ticket` (
    ...
    `channel` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'whatsapp/telegram/line/im/400_call',
    `terminal_type` varchar(16) NULL DEFAULT NULL COMMENT 'APP/MINIAPP/H5/WEB/PC（channel=im）',
...
CREATE TABLE IF NOT EXISTS `cs_idle_policy` (
    ...
    `agent_conn_idle_warn_sec` int NOT NULL DEFAULT 180,
    `agent_conn_idle_close_strike` int NOT NULL DEFAULT 0,
    ...
    `resume_when_active_full` tinyint NOT NULL DEFAULT 0 COMMENT '0=PENDING_RESUME',
...
CREATE TABLE IF NOT EXISTS `cs_agent_credential` (
    `id` bigint(20) NOT NULL COMMENT '主键',
    `app_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `agent_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `password_hash` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'SHA256 十六进制',
    `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE KEY `uk_app_agent` (`app_key`, `agent_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '坐席登录凭据' ROW_FORMAT = Dynamic;
...
VALUES
 (2001, 'default', 'agent_001', '坐席张三', 'A001', 1, 5, 1, 0),
 (2002, 'default', 'agent_002', '坐席李四', 'A002', 1, 5, 1, 0);

INSERT IGNORE INTO cs_agent_skill_rel (id, app_key, agent_id, skill_code, weight, enabled, deleted)
VALUES
 (3001, 'default', 'agent_001', 'GENERAL', 10, 1, 0),
 (3002, 'default', 'agent_002', 'GENERAL', 10, 1, 0);
