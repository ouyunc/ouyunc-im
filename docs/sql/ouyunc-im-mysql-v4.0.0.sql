...
-- ----------------------------
-- Records of ouyunc_im_blacklist
-- ----------------------------

-- ----------------------------
-- Table structure for ouyunc_im_file
-- ----------------------------
DROP TABLE IF EXISTS `ouyunc_im_file`;
CREATE TABLE `ouyunc_im_file`  (
  `id` bigint NOT NULL COMMENT '主键id',
  `file_origin_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件原始名称',
  `file_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件名称，包含后缀名',
  `file_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件网络访问完整路径：http(s)://xxxxx',
  `file_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件半路径，一般为存放目录+文件名',
  `file_type` tinyint(1) NOT NULL COMMENT '文件类型，标识是哪种业务类型的文件：1-语音文件',
  `file_md5` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件的md5',
  `file_suffix` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件后缀名',
...
-- ----------------------------
-- Records of ouyunc_im_group_user
-- ----------------------------
...
-- ----------------------------
-- Records of ouyunc_im_read_receipt
-- ----------------------------
...
CREATE TABLE `ouyunc_im_receive_message`  (
  ...
  `receive_time` bigint NULL DEFAULT NULL COMMENT '消息接收时间',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否删除，1-已删除，0-未删除',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Records of ouyunc_im_receive_message
-- ----------------------------
...
-- ----------------------------
-- Records of ouyunc_im_send_message
-- ----------------------------
