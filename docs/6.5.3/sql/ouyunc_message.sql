...
CREATE TABLE `ouyunc_im_friend`  (
  ...
  `way` tinyint(1) NULL DEFAULT 1 COMMENT '会话session 加好友方式：1-主动加好友，2-扫码加好友',
  `channel` tinyint(1) NULL DEFAULT 1 COMMENT '会话渠道，从哪里加入的，预留,默认1',
...
CREATE TABLE `ouyunc_im_message` (
                                     ...
                                     `correlation_id` varchar(64) NOT NULL COMMENT '业务关联id，非必填',
