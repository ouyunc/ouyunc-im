 ...
 * @const
 */
proto.com.ouyunc.base.packet.message.Message.repeatedFields_ = [5,6];
...
proto.com.ouyunc.base.packet.message.Message.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    refList: (f = jspb.Message.getRepeatedField(msg, 6)) == null ? undefined : f,
    extra: jspb.Message.getFieldWithDefault(msg, 7, ""),
    qos: jspb.Message.getFieldWithDefault(msg, 8, 0),
