...
public interface SentinelRedissonProperties extends Config{
     ...
     **/
    @Config.Key("cache.redis.sentinel.redisson.master")
     ...
     **/
    @Config.Key("cache.redis.sentinel.redisson.nodes")
     ...
     * redis 连接数据库配置,默认0
     **/
    @Config.Key("cache.redis.sentinel.redisson.database")
    @DefaultValue("0")
    int database();
     ...
     * redis 密码
     **/
    @Config.Key("cache.redis.sentinel.redisson.password")
    String password();

    /**
     * redis 连接超时时间
     **/
    @Config.Key("cache.redis.sentinel.redisson.timeout")
    @DefaultValue("1000")
    int timeout();
    /**
     * redis 连接超时时间
     **/
    @Config.Key("cache.redis.sentinel.redisson.conn-timeout")
    @DefaultValue("10000")
    int connTimeout();
     ...
     * 以毫秒为单位的值
     **/
    @Config.Key("cache.redis.sentinel.redisson.so-timeout")
    @DefaultValue("10000")
    int soTimeout();
     ...
     * redis 连接池大小默认
     **/
    @Config.Key("cache.redis.sentinel.redisson.poll-size")
    @DefaultValue("50")
    int pollSize();
