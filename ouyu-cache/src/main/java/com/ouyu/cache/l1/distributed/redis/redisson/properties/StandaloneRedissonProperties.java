...
public interface StandaloneRedissonProperties extends Config{
     ...
     * redis 连接数据库配置,默认0
     **/
    @Config.Key("cache.redis.standalon.redisson.database")
    @DefaultValue("0")
    int database();
     ...
     * redis 主机地址
     **/
    @Config.Key("cache.redis.standalon.redisson.host")
     ...
     * redis 主机端口号
     **/
    @Config.Key("cache.redis.standalon.redisson.port")
    @DefaultValue("6379")
    int port();
     ...
     * redis 主机密码
     **/
    @Config.Key("cache.redis.standalon.redisson.password")
    String password();

    /**
     * redis 响应超时时间
     **/
    @Config.Key("cache.redis.standalon.redisson.timeout")
    @DefaultValue("1000")
    int timeout();
     ...
     * redis 连接超时时间
     **/
    @Config.Key("cache.redis.standalon.redisson.conn-timeout")
    @DefaultValue("10000")
    int connTimeout();
     ...
     * 以毫秒为单位的值
     **/
    @Config.Key("cache.redis.standalon.redisson.so-timeout")
    @DefaultValue("10000")
    int soTimeout();
     ...
     * redis 连接池大小默认
     **/
    @Config.Key("cache.redis.standalon.redisson.poll-size")
    @DefaultValue("50")
    int pollSize();
