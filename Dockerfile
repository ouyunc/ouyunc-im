...
# 运行：docker compose up -d   或
#   docker run --rm -p 6003:6003 -e JAVA_OPTS="-Xms8g -Xmx8g" ouyunc-im:latest
...
ENV TZ=Asia/Shanghai \
    JAVA_OPTS="-XX:+UseContainerSupport -Xms10g -Xmx10g -XX:+UseG1GC -XX:MaxGCPauseMillis=200 -Dfile.encoding=UTF-8 -Dstdout.encoding=UTF-8 -Dstderr.encoding=UTF-8"
