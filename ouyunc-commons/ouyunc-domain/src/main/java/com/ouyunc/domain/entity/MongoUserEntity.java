...
public class MongoUserEntity extends UserEntity {
    ...
    public MongoUserEntity(String id, String openId, String code, String username, String password, String nickName, String avatar, String motto, Integer age, Integer sex, String email, String phoneNum, String idCardNo, Integer groupInvitePolicy, Integer friendJoinPolicy, Integer status, String appKey, Integer robot, LocalDateTime createTime, LocalDateTime updateTime, Integer deleted, LocalDateTime expireAt) {
        super(id, openId, code, username, password, nickName, avatar, motto, age, sex, email, phoneNum, idCardNo, groupInvitePolicy, friendJoinPolicy, status, appKey, robot, createTime, updateTime, deleted);
        this.expireAt = expireAt;
    }
}
