...
public class FriendEntity implements Serializable {
    ...
    */
    ...
    /**
     * 消息投递渠道，见 {@link com.ouyunc.base.constant.enums.MessageDeliveryChannelEnum}。
     * 标识与该好友聊天时接收方走 IM 长连接还是外部厂商（WhatsApp / Telegram 等）。
     * 外部渠道用户在系统内为独立 userId，与 IM 多设备漫游无关。
     */
