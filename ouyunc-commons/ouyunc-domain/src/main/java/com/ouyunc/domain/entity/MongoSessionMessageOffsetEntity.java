...
public class MongoSessionMessageOffsetEntity {

    @Id
    private String id; // MongoDB自动生成的唯一标识
    ...
    // 构造方法
    public MongoSessionMessageOffsetEntity() {}
    
    public MongoSessionMessageOffsetEntity(Long from, Long to, Integer type, Long sessionMessageOffset) {
        this.from = from;
        this.to = to;
        this.type = type;
