...
public class Message implements Serializable, Cloneable {
    ...
    public Message(String from, String to, int contentType, String content, List<String> at, List<String> ref, String extra, int qos, long createTime, Metadata metadata) {
        this.from = from;
        this.to = to;
        this.contentType = contentType;
        this.content = content;
