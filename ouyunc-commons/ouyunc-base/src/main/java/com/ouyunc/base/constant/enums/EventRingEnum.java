...
public enum EventRingEnum {
    ...
    FAST(2048, WaitStrategyMode.YIELDING, ProducerType.MULTI),

    /** 普通业务事件（默认） */
    NORMAL(1024, WaitStrategyMode.BLOCKING, ProducerType.MULTI),

    /** 耗时较长的事件（日志、统计、持久化等） */
    SLOW(512, WaitStrategyMode.BLOCKING, ProducerType.MULTI);
