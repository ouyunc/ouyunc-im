...
public enum MessageTypeEnum implements MessageType {
    QOS_S2C_ACK(NumberConstant.NUMBER_NEGATIVE_1, ProtocolTypeEnum.ZERO.getProtocol(), ProtocolTypeEnum.ZERO.getProtocolVersion(), "s2c_ack",  "qos  服务端发送给客户端的，标识服务端已收到客户端传来的消息"),
